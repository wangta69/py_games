...
# 이미지 파일을 로딩
img = pygame.image.load('assets/bird.jpg')

# 폰트 로딩 및 텍스트 객체 초기화
fontObj = pygame.font.Font('assets/NanumPen.ttf', 32)
textSurfaceObj = fontObj.render('NanumPen Font!', True, GREEN)
textRectObj = textSurfaceObj.get_rect();
textRectObj.center = (150, 200)

# 사운드 파일을 로딩
soundObj = pygame.mixer.Sound('assets/beeps.wav')
